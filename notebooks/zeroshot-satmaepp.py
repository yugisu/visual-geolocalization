...
def _(DEVICE):
    ...
    model = SatMAEPP.from_pretrained("MVRL/satmaepp_ViT-L_pretrain_fmow_rgb")
...
@app.cell
def _(DEVICE, DataLoader, F, model, time, torch, tqdm):
...
@app.cell
def _(DataLoader, NUM_WORKERS, SatChunkDataset, UAVDataset, transforms, visloc_root):
    FLIGHT_ID = "03"
...
def _(
    ...
    entry = {
        "model": "MVRL/satmaepp_ViT-L_pretrain_fmow_rgb",
